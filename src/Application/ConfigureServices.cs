...
using Application.Contract.Validator;
...
public static class ConfigureServices
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddMediatR(cfg => {
            ...
            services.AddTransient(typeof(IPipelineBehavior<CreateOrderCommand, int>), typeof(CreateTimeOrderValidator));
            services.AddTransient(typeof(IPipelineBehavior<CreateOrderCommand, int>), typeof(CreateAmountOrderValidator));
        });
